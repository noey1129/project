...
(function () {
  ...
  var email = sessionStorage.getItem('user_email') || 'test@sendit.kr';
  ...
  sidebar.innerHTML =
    '<a href="mypage.html" class="mypage-sidebar__logo"><img src="assets/Lawsign.svg" alt="Lawsign" height="22"></a>' +
