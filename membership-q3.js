/* ================================================================
   SENDIT – MEMBERSHIP Q3 JS
   ================================================================ */

const STORE_KEY = 'membership_q3';
...
btnPrev.addEventListener('click', function () { window.location.href = 'membership-q2.html'; });
btnNext.addEventListener('click', function () {
  sessionStorage.setItem(STORE_KEY, textarea.value.trim());
  window.location.href = 'membership-q4.html';
});
