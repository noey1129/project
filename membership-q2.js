/* ================================================================
   SENDIT – MEMBERSHIP Q2 JS
   ================================================================ */

const STORE_YEAR  = 'membership_q2_year';
const STORE_MONTH = 'membership_q2_month';
const STORE_DAY   = 'membership_q2_day';
...
btnPrev.addEventListener('click', function () { window.location.href = 'membership-q1.html'; });
...
btnNext.addEventListener('click', function () {
  ...
  window.location.href = 'membership-q3.html';
});
